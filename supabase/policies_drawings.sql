...
-- Célja: User látja saját projekt rajzait, Admin mindent
...
'SELECT policy: User látja saját projektjeihez tartozó aktív rajzokat, Admin mindent (törölt rajzokkal együtt)';
